...
function addTodo(event) {
    ...
    if ((todoType.value.trim() !== "") && (!todos.includes(todoType.value))) {
        // Create Todo List
        createTodoList(todoType.value);
        // Save Todo to local storage
        saveLocalTodos(todoType.value);
        // Clear todo input value
        todoType.value = "";
    } else {
        alert("Add New Task Only ❗❗❗");
    ...
    if ((todoDate.value.trim() !== "") && (!todos.includes(todoDate.value))) {
        // Create Todo List
        createTodoList(todoDate.value);
        // Save Todo to local storage
